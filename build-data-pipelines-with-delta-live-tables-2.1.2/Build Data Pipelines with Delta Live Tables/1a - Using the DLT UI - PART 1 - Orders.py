...
# MAGIC     
# MAGIC ![maintenance_label](files/images/build-data-pipelines-with-delta-live-tables-2.1.2/maintenance_label.png)
# MAGIC
...
# MAGIC
# MAGIC
# MAGIC ![ValidateOneNotebookDLTPipeline](files/images/build-data-pipelines-with-delta-live-tables-2.1.2/ValidateOneNotebookDLTPipeline.png)
...
# MAGIC </br>
# MAGIC
# MAGIC ![RunOneNotebookDLTPipeline](files/images/build-data-pipelines-with-delta-live-tables-2.1.2/RunOneNotebookDLTPipeline.png)
